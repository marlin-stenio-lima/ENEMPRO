...
const STATS = [
    { title: 'Questões Resolvidas', value: '142', sub: '+12 hoje', icon: Target, color: 'text-blue-600', bg: 'bg-blue-50' },
    { title: 'Precisão Geral', value: '68%', sub: '+2.4% essa semana', icon: Award, color: 'text-green-600', bg: 'bg-green-50' },
    { title: 'Tempo Médio', value: '2m 15s', sub: 'por questão', icon: Clock, color: 'text-orange-600', bg: 'bg-orange-50' },
                ...
                <div className="bg-gradient-to-br from-indigo-900 to-slate-900 p-6 rounded-2xl text-white relative overflow-hidden shadow-lg">
                    ...
                    <div className="relative z-10 flex flex-col h-full justify-between">
                        <div>
                            ...
                            <p className="text-white/60 text-sm">Faltam resolver 28 questões para bater sua meta hoje.</p>
                        </div>
